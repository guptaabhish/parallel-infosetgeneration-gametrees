...
Figure~\ref{filteredlisting},~\ref{fig:figure1} and \ref{fig:figure2} show a full listing and the associated pictorial progression of an actual
kriegspiel game~\cite{li94chess}.  We have adopted the notation used by Wolfe for Berkeley Kriegspiel.  Odd (resp. even) moves are for white (resp. black).  The actual move is shown
...
declared illegal are shown in a list following the `:'.  For example at move 9, (Figure~\ref{filteredlisting}),
...
\centering
\subfigure[Depth 8]{
\includegraphics[width=2.2in]{plots/dep8.pdf}
\label{dep8}
} 
\subfigure[Depth 10]{
\includegraphics[width=2.2in]{plots/dep10.pdf}
\label{dep10}
} 
\subfigure[Depth 12]{
\includegraphics[width=2.2in]{plots/dep12.pdf}
\label{dep12}
} 
\vspace{-0.1in}
...
Figures~\ref{dep8}--~\ref{dep12}.  It is clear that there is a ``sweet spot'' for each problem size.  (At least it is
...
\caption{Kriegspiel position from 2 games, postiion 10}
\label{prob4} 
\vspace{-0.2in}
\end{figure}
