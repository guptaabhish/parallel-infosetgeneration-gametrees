...
fully-CLOS topology providing a 1GBps point-to-point bandwidth. We used Charm++'s \texttt{net-ibverbs} machine layer build and $-O3$ optimization for these experiments.
