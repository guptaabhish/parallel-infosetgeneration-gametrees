...
of Kriegspiel using problem instances from real games. We achieve results which are unprecendented in game tree search application. 
\item
We demonstrate
...
that coin. At move 9, Black attempts to block a
