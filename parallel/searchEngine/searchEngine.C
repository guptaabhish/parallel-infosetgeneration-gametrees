...
SearchNode::SearchNode(SearchNodeMsg *msg){
  ...
  //unsigned int *__priority = (unsigned int *)(CkPriorityPtr(msg));
  //UShort len = UsrToEnv(msg)->getPrioBytes();
  qs.setCurrentPriority(0, 0);
